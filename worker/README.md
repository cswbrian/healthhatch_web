...
wrangler secret put REDIRECT_URI  # e.g., https://auth.healthhatch.co/callback
wrangler secret put SITE_URL      # e.g., https://healthhatch.co
```
...
```
https://auth.healthhatch.co/callback
```
...
backend:
  ...
  branch: main
  base_url: https://auth.healthhatch.co  # Your worker URL
  auth_endpoint: /auth
```

## Testing

1. Visit `https://healthhatch.co/admin/`
